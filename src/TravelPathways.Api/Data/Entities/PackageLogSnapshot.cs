...
/// <summary>Full package form state stored in <see cref="PackageLog.SnapshotJson"/>.</summary>
public sealed class PackageLogSnapshot
{
...
public sealed class PackageLogDaySnapshot
{
